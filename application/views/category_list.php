<div id="container">
      ...
      <div id="content">
        ...
        <div class="product-filter">
          <div class="display"><b>Display:</b> <a href="<?php echo site_url('Home/categories/grid')?>" class="grid-icon">Grid</a><span class="list1-icon">List</span> </div>
          ...
          <div>
            <div class="left">
              ...
              <div class="cart">
                ...
                <div class="compare"><a onClick="addToCompare('42');">Add to Compare</a></div>
              </div>
            </div>
          </div>
          <div>
            <div class="left">
              ...
              <div class="description">Video in your pocket. Its the small iPod with one very big idea: video. The worlds most popular..</div>
              <div class="price"> <span class="price-old">$119.50</span> <span class="price-new">$107.75</span> <br>
                <span class="price-tax">Ex Tax: $90.00</span> </div>
              <div class="rating"><img src="<?php echo base_url(); ?>image/stars-4.png" alt="Based on 1 reviews." /></div>
              <div class="cart">
