<div id="container">
      <div id="column-left">
        ...
        <div class="box">
          ...
          <div class="box-content box-category">
            <ul id="cat_accordion">
              <li class="custom_id20"><a class="active" href="category.html">Electronics</a> <span class="down"></span>
                <ul>
                  <li class="custom_id26"><a class="" href="category.html">Laptops</a></li>
      ...
      <div id="content">
        ...
        <div class="product-filter">
          <div class="display"><b>Display:</b> <span class="grid1-icon">Grid</span> <a href="<?php echo site_url('Home/categories/list')?>" class="list-icon">List</a></div>
        ...
        <div class="product-grid">
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/apple_cinema_30-162x162.jpg" title="Apple Cinema 30&quot;" alt="Apple Cinema 30&quot;" /></a></div>
            <div class="name"><a href="product.html">Apple Cinema 30&quot;</a></div>
          ...
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/canon_eos_5d_1-162x162.jpg" title="Canon EOS 5D" alt="Canon EOS 5D" /></a></div>
            ...
            <div class="rating"><img src="<?php echo base_url(); ?>image/stars-2.png" alt="Based on 1 reviews." /></div>
          </div>
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/ipod_classic_1-162x162.jpg" title="iPad Classic" alt="iPad Classic" /></a></div>
            <div class="name"><a href="product.html">iPad Classic</a></div>
          ...
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/ipod_nano_1-162x162.jpg" title="iPad Retina 2" alt="iPad Retina 2" /></a></div>
          ...
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/iphone_1-162x162.jpg" title="iPhone 4s" alt="iPhone 4s" /></a></div>
          ...
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/htc_touch_hd_1-162x162.jpg" title="iPhone 5s" alt="iPhone 5s" /></a></div>
            ...
            <div class="rating"><img src="<?php echo base_url(); ?>image/stars-3.png" alt="Based on 1 reviews." /></div>
          </div>
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/palm_treo_pro_1-162x162.jpg" title="Laptop Treo Pro" alt="Laptop Treo Pro" /></a></div>
            ...
            <div class="rating"><img src="<?php echo base_url(); ?>image/stars-5.png" alt="Based on 1 reviews." /></div>
          </div>
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/nikon_d300_1-162x162.jpg" title="Nikon D300" alt="Nikon D300" /></a></div>
            ...
            <div class="rating"><img src="<?php echo base_url(); ?>image/stars-1.png" alt="Based on 1 reviews." /></div>
          </div>
          <div>
            <div class="image"><a href="product.html"><img src="<?php echo base_url(); ?>image/product/iphone_1-162x162.jpg" title="iPhone 4s" alt="iPhone 4s" /></a></div>
            <div class="name"><a href="product.html">iPhone 4s</a></div>
